...
const Newsletter = () => {
  return (
    <div className='flex flex-col itmes-center justify-center text-center space-y-2 my-32'>
      <h1 className='md:text-4x1 text-2x1 font-semibold '>Never Miss a Blog!</h1>
        <p className='md:text-lg text-gray-500/70 pb-8'>Subscribe to our newsletter for the latest updates.</p>
        <form className='flex items-center justify-between max-w-2x1 w-full md:h-13 h-12'>
